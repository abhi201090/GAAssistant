...
export class AddTermDialogContent extends DialogComponent<Term, boolean> implements Term, OnInit {
  ...
  options: DatepickerOptions = {
    ...
    locale: frLocale,
    minDate: this.from, // Minimal selectable date
    maxDate: new Date(Date.parse(this.to.setDate(this.to.getDate() + 1) .toLocaleString()))  // Maximal selectable date
  };
