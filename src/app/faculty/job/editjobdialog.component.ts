...
@Component({
    selector: 'job-data',
    templateUrl: 'editjobdialog.component.html',
    styleUrls: ['editjobdialog.component.css'],
    encapsulation: ViewEncapsulation.None,
    host: {
        'class': 'modal-new'
    }
})
export class EditJobDialogContent extends DialogComponent<Job, boolean> implements Job, OnInit {
    ...
    validTerms = [];
    selectedterm: string;
    dateerrors: any = { isError: false, errorMessages: [] };
    minmaxerrors: any = { isError: false, errorMessages: [] };
    termerror: any = { isError: false, errorMessage: '' };
    ...
    confirm() {
        ...
        this.userService.updateJob(data).subscribe(res=>{
            this.loading = false;
        });
        this.result= true;
        this.close();
